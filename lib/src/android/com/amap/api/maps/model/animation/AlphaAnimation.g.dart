...
class com_amap_api_maps_model_animation_AlphaAnimation
  ...
  //region creators
  static Future<com_amap_api_maps_model_animation_AlphaAnimation>
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            ...
            {"var1": var1, "var2": var2});
    final object = com_amap_api_maps_model_animation_AlphaAnimation()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_model_animation_AlphaAnimation>>
    ...
    final List<com_amap_api_maps_model_animation_AlphaAnimation> typedResult =
        resultBatch
            .map((result) => com_amap_api_maps_model_animation_AlphaAnimation()
              ..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_animation_AlphaAnimation_Batch
    on List<com_amap_api_maps_model_animation_AlphaAnimation> {
  //region getters
