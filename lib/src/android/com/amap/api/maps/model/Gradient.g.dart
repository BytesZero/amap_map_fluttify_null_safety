...
class com_amap_api_maps_model_Gradient extends java_lang_Object {
  ...
  //region creators
  static Future<com_amap_api_maps_model_Gradient> create__intArray__floatArray(
  ...
  static Future<List<com_amap_api_maps_model_Gradient>>
      create_batch__intArray__floatArray(
          List<Int32List> var1, List<Float64List> var2) async {
    ...
    final List<com_amap_api_maps_model_Gradient> typedResult = resultBatch
        .map((result) => com_amap_api_maps_model_Gradient()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<Int32List> getColors() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.Gradient@$refId::getColors([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.Gradient::getColors', {"__this__": this});
  ...
  Future<Float64List> getStartPoints() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.Gradient@$refId::getStartPoints([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.Gradient::getStartPoints',
            {"__this__": this});
...
extension com_amap_api_maps_model_Gradient_Batch
    on List<com_amap_api_maps_model_Gradient> {
  //region getters
  ...
  Future<List<Int32List>> getColors_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.Gradient::getColors_batch', [
  ...
  Future<List<Float64List>> getStartPoints_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.Gradient::getStartPoints_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
