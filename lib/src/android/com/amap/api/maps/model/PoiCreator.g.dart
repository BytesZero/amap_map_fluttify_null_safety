...
class com_amap_api_maps_model_PoiCreator extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_PoiCreator>> create_batch__(
      int length) async {
    if (false) {
    ...
    final List<com_amap_api_maps_model_PoiCreator> typedResult = resultBatch
        .map((result) => com_amap_api_maps_model_PoiCreator()..refId = result)
        .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_PoiCreator_Batch
    on List<com_amap_api_maps_model_PoiCreator> {
  //region getters
