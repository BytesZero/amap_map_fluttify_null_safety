...
class com_amap_api_maps_model_LatLng extends java_lang_Object
  ...
  //region creators
  static Future<com_amap_api_maps_model_LatLng> create__double__double(
  ...
  static Future<com_amap_api_maps_model_LatLng> create__double__double__boolean(
      double var1, double var3, bool var5) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
  ...
  static Future<List<com_amap_api_maps_model_LatLng>>
      create_batch__double__double(List<double> var1, List<double> var3) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
          ...
          for (int __i__ = 0; __i__ < var1.length; __i__++)
            {"var1": var1[__i__], "var3": var3[__i__]}
        ]);

    final List<com_amap_api_maps_model_LatLng> typedResult = resultBatch
        .map((result) => com_amap_api_maps_model_LatLng()..refId = result)
        .toList();
    return typedResult;
  }

  static Future<List<com_amap_api_maps_model_LatLng>>
      create_batch__double__double__boolean(
          List<double> var1, List<double> var3, List<bool> var5) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            ...
            [
          for (int __i__ = 0; __i__ < var1.length; __i__++)
            {"var1": var1[__i__], "var3": var3[__i__], "var5": var5[__i__]}
        ]);
  ...
  Future<double> get_latitude() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.LatLng::get_latitude", {'__this__': this});
  ...
  Future<double> get_longitude() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("com.amap.api.maps.model.LatLng::get_longitude",
            {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<com_amap_api_maps_model_LatLng> clone() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.LatLng@$refId::clone([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.LatLng::clone', {"__this__": this});
...
extension com_amap_api_maps_model_LatLng_Batch
  ...
  Future<List<double>> get_latitude_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("com.amap.api.maps.model.LatLng::get_latitude_batch", [
  ...
  Future<List<double>> get_longitude_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("com.amap.api.maps.model.LatLng::get_longitude_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<com_amap_api_maps_model_LatLng>> clone_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.LatLng::clone_batch', [
