...
class com_amap_api_maps_model_MarkerOptionsCreator extends java_lang_Object {
  ...
  static Future<com_amap_api_maps_model_MarkerOptionsCreator> create__() async {
    ...
    final object = com_amap_api_maps_model_MarkerOptionsCreator()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_model_MarkerOptionsCreator>>
    ...
    final List<com_amap_api_maps_model_MarkerOptionsCreator> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_MarkerOptionsCreator()..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_MarkerOptionsCreator_Batch
    on List<com_amap_api_maps_model_MarkerOptionsCreator> {
  //region getters
