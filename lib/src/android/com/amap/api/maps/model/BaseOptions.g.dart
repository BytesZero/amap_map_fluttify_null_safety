...
class com_amap_api_maps_model_BaseOptions extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_BaseOptions>> create_batch__(
      int length) async {
    if (false) {
    ...
    final List<com_amap_api_maps_model_BaseOptions> typedResult = resultBatch
        .map((result) => com_amap_api_maps_model_BaseOptions()..refId = result)
        .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_BaseOptions_Batch
    on List<com_amap_api_maps_model_BaseOptions> {
  //region getters
