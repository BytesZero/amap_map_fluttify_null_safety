...
class com_amap_api_maps_model_GroundOverlayOptionsCreator
  ...
  //region creators
  static Future<com_amap_api_maps_model_GroundOverlayOptionsCreator>
      create__() async {
    ...
    final object = com_amap_api_maps_model_GroundOverlayOptionsCreator()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_model_GroundOverlayOptionsCreator>>
    ...
    final List<com_amap_api_maps_model_GroundOverlayOptionsCreator>
        typedResult = resultBatch
            .map((result) =>
                com_amap_api_maps_model_GroundOverlayOptionsCreator()
                  ..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_GroundOverlayOptionsCreator_Batch
    on List<com_amap_api_maps_model_GroundOverlayOptionsCreator> {
  //region getters
