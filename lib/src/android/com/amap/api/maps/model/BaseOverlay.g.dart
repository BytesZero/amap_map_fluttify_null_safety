...
class com_amap_api_maps_model_BaseOverlay extends java_lang_Object {
  ...
  //region creators
  static Future<com_amap_api_maps_model_BaseOverlay> create__String(
      String var1) async {
  ...
  static Future<List<com_amap_api_maps_model_BaseOverlay>> create_batch__String(
    ...
    final List<com_amap_api_maps_model_BaseOverlay> typedResult = resultBatch
        .map((result) => com_amap_api_maps_model_BaseOverlay()..refId = result)
        .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_BaseOverlay_Batch
    on List<com_amap_api_maps_model_BaseOverlay> {
  //region getters
