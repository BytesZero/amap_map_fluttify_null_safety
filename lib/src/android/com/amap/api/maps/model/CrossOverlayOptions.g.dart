...
class com_amap_api_maps_model_CrossOverlayOptions extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_CrossOverlayOptions>>
    ...
    final List<com_amap_api_maps_model_CrossOverlayOptions> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_CrossOverlayOptions()..refId = result)
            .toList();
    return typedResult;
  }
  ...
  Future<com_amap_api_maps_model_CrossOverlayOptions> setRes(
      android_graphics_Bitmap var1) async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.CrossOverlayOptions@$refId::setRes([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.CrossOverlayOptions::setRes',
    ...
    if (__result__ == null) {
      ...
      final __return__ = com_amap_api_maps_model_CrossOverlayOptions()
        ..refId = __result__;
      return __return__;
    }
  }
  ...
  Future<android_graphics_Bitmap> getRes() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.CrossOverlayOptions@$refId::getRes([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.CrossOverlayOptions::getRes',
            {"__this__": this});
...
extension com_amap_api_maps_model_CrossOverlayOptions_Batch
    on List<com_amap_api_maps_model_CrossOverlayOptions> {
  //region getters
  ...
  Future<List<com_amap_api_maps_model_CrossOverlayOptions>> setRes_batch(
      List<android_graphics_Bitmap> var1) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.CrossOverlayOptions::setRes_batch', [
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List)
          .cast<String>()
          .map((__result__) =>
              com_amap_api_maps_model_CrossOverlayOptions()..refId = __result__)
          .toList();
      return typedResult;
    }
  }
  ...
  Future<List<android_graphics_Bitmap>> getRes_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.CrossOverlayOptions::getRes_batch', [
