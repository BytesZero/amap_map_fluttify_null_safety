...
class com_amap_api_maps_model_animation_AnimationSet
  ...
  //region creators
  static Future<com_amap_api_maps_model_animation_AnimationSet> create__boolean(
      bool var1) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            ...
            {"var1": var1});
    final object = com_amap_api_maps_model_animation_AnimationSet()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_model_animation_AnimationSet>>
      create_batch__boolean(List<bool> var1) async {
    if (false) {
    ...
    final List<com_amap_api_maps_model_animation_AnimationSet> typedResult =
        resultBatch
            .map((result) => com_amap_api_maps_model_animation_AnimationSet()
              ..refId = result)
            .toList();
    return typedResult;
  }
  ...
  Future<void> addAnimation(
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.animation.AnimationSet@$refId::addAnimation([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.animation.AnimationSet::addAnimation',
  ...
  Future<void> cleanAnimation() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.animation.AnimationSet@$refId::cleanAnimation([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.animation.AnimationSet::cleanAnimation',
            {"__this__": this});
...
extension com_amap_api_maps_model_animation_AnimationSet_Batch
    on List<com_amap_api_maps_model_animation_AnimationSet> {
  //region getters
  ...
  Future<List<void>> addAnimation_batch(
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.animation.AnimationSet::addAnimation_batch',
            [
  ...
  Future<List<void>> cleanAnimation_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.animation.AnimationSet::cleanAnimation_batch',
            [
