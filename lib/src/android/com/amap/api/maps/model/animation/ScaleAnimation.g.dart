...
class com_amap_api_maps_model_animation_ScaleAnimation
  ...
  //region creators
  static Future<com_amap_api_maps_model_animation_ScaleAnimation>
      create__float__float__float__float(
          double var1, double var2, double var3, double var4) async {
    ...
    final object = com_amap_api_maps_model_animation_ScaleAnimation()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_model_animation_ScaleAnimation>>
      create_batch__float__float__float__float(List<double> var1,
          List<double> var2, List<double> var3, List<double> var4) async {
    ...
    final List<com_amap_api_maps_model_animation_ScaleAnimation> typedResult =
        resultBatch
            .map((result) => com_amap_api_maps_model_animation_ScaleAnimation()
              ..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_animation_ScaleAnimation_Batch
    on List<com_amap_api_maps_model_animation_ScaleAnimation> {
  //region getters
