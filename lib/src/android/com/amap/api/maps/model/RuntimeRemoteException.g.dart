...
class com_amap_api_maps_model_RuntimeRemoteException extends java_lang_Object {
  ...
  //region creators
  static Future<com_amap_api_maps_model_RuntimeRemoteException> create__String(
      String var1) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            ...
            {"var1": var1});
    final object = com_amap_api_maps_model_RuntimeRemoteException()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_model_RuntimeRemoteException>>
      create_batch__String(List<String> var1) async {
    if (false) {
    ...
    final List<com_amap_api_maps_model_RuntimeRemoteException> typedResult =
        resultBatch
            .map((result) => com_amap_api_maps_model_RuntimeRemoteException()
              ..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_RuntimeRemoteException_Batch
    on List<com_amap_api_maps_model_RuntimeRemoteException> {
  //region getters
