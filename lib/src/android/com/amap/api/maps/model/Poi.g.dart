...
class com_amap_api_maps_model_Poi extends java_lang_Object
  ...
  //region creators
  static Future<com_amap_api_maps_model_Poi>
      create__String__com_amap_api_maps_model_LatLng__String(
          String var1, com_amap_api_maps_model_LatLng var2, String var3) async {
  ...
  static Future<List<com_amap_api_maps_model_Poi>>
      create_batch__String__com_amap_api_maps_model_LatLng__String(
          List<String> var1,
          List<com_amap_api_maps_model_LatLng> var2,
          List<String> var3) async {
    ...
    final List<com_amap_api_maps_model_Poi> typedResult = resultBatch
        .map((result) => com_amap_api_maps_model_Poi()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<String> getName() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.Poi@$refId::getName([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.Poi::getName', {"__this__": this});
  ...
  Future<com_amap_api_maps_model_LatLng> getCoordinate() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.Poi@$refId::getCoordinate([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.Poi::getCoordinate', {"__this__": this});
  ...
  Future<String> getPoiId() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.Poi@$refId::getPoiId([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.Poi::getPoiId', {"__this__": this});
...
extension com_amap_api_maps_model_Poi_Batch
    on List<com_amap_api_maps_model_Poi> {
  //region getters
  ...
  Future<List<String>> getName_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.Poi::getName_batch', [
  ...
  Future<List<com_amap_api_maps_model_LatLng>> getCoordinate_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.Poi::getCoordinate_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<String>> getPoiId_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.Poi::getPoiId_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
