...
class com_amap_api_maps_model_animation_TranslateAnimation
  ...
  //region creators
  static Future<com_amap_api_maps_model_animation_TranslateAnimation>
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            ...
            {"var1": var1});
    final object = com_amap_api_maps_model_animation_TranslateAnimation()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_model_animation_TranslateAnimation>>
    ...
    final List<com_amap_api_maps_model_animation_TranslateAnimation>
        typedResult = resultBatch
            .map((result) =>
                com_amap_api_maps_model_animation_TranslateAnimation()
                  ..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_animation_TranslateAnimation_Batch
    on List<com_amap_api_maps_model_animation_TranslateAnimation> {
  //region getters
