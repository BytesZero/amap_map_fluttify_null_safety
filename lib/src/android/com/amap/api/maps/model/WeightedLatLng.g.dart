...
class com_amap_api_maps_model_WeightedLatLng extends java_lang_Object {
  ...
  //region creators
  static Future<com_amap_api_maps_model_WeightedLatLng>
      create__com_amap_api_maps_model_LatLng__double(
  ...
  static Future<List<com_amap_api_maps_model_WeightedLatLng>>
      create_batch__com_amap_api_maps_model_LatLng__double(
    ...
    final List<com_amap_api_maps_model_WeightedLatLng> typedResult = resultBatch
        .map((result) =>
            com_amap_api_maps_model_WeightedLatLng()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<double> get_intensity() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("com.amap.api.maps.model.WeightedLatLng::get_intensity",
            {'__this__': this});
  ...
  Future<com_amap_api_maps_model_LatLng> get_latLng() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("com.amap.api.maps.model.WeightedLatLng::get_latLng",
            {'__this__': this});
...
extension com_amap_api_maps_model_WeightedLatLng_Batch
  ...
  Future<List<com_amap_api_maps_model_LatLng>> get_latLng_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.WeightedLatLng::get_latLng_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
