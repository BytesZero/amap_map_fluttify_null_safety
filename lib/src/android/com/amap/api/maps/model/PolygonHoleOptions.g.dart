...
class com_amap_api_maps_model_PolygonHoleOptions
  ...
  static Future<List<com_amap_api_maps_model_PolygonHoleOptions>>
    ...
    final List<com_amap_api_maps_model_PolygonHoleOptions> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_PolygonHoleOptions()..refId = result)
            .toList();
    return typedResult;
  }
  ...
  Future<com_amap_api_maps_model_PolygonHoleOptions> addAll(
      List<com_amap_api_maps_model_LatLng> var1) async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.PolygonHoleOptions@$refId::addAll([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.PolygonHoleOptions::addAll',
    ...
    if (__result__ == null) {
      ...
      final __return__ = com_amap_api_maps_model_PolygonHoleOptions()
        ..refId = __result__;
      return __return__;
    }
  }
  ...
  Future<List<com_amap_api_maps_model_LatLng>> getPoints() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.PolygonHoleOptions@$refId::getPoints([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.PolygonHoleOptions::getPoints',
            {"__this__": this});
...
extension com_amap_api_maps_model_PolygonHoleOptions_Batch
    on List<com_amap_api_maps_model_PolygonHoleOptions> {
  //region getters
  ...
  Future<List<com_amap_api_maps_model_PolygonHoleOptions>> addAll_batch(
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.PolygonHoleOptions::addAll_batch', [
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List)
          .cast<String>()
          .map((__result__) =>
              com_amap_api_maps_model_PolygonHoleOptions()..refId = __result__)
          .toList();
      return typedResult;
    }
  }
  ...
  Future<List<List<com_amap_api_maps_model_LatLng>>> getPoints_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.PolygonHoleOptions::getPoints_batch', [
