...
class com_amap_api_maps_model_ArcOptionsCreator extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_ArcOptionsCreator>> create_batch__(
      int length) async {
    if (false) {
    ...
    final List<com_amap_api_maps_model_ArcOptionsCreator> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_ArcOptionsCreator()..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_ArcOptionsCreator_Batch
    on List<com_amap_api_maps_model_ArcOptionsCreator> {
  //region getters
