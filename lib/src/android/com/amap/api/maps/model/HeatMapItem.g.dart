...
class com_amap_api_maps_model_HeatMapItem extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_HeatMapItem>> create_batch__(
      int length) async {
    if (false) {
    ...
    final List<com_amap_api_maps_model_HeatMapItem> typedResult = resultBatch
        .map((result) => com_amap_api_maps_model_HeatMapItem()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<com_amap_api_maps_model_LatLng> getCenter() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.HeatMapItem@$refId::getCenter([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::getCenter',
            {"__this__": this});
  ...
  Future<void> setCenter(double var1, double var3) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.HeatMapItem@$refId::setCenter([\'var1\':$var1, \'var3\':$var3])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::setCenter',
            {"var1": var1, "var3": var3, "__this__": this});
  ...
  Future<double> getIntensity() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.HeatMapItem@$refId::getIntensity([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::getIntensity',
            {"__this__": this});
  ...
  Future<void> setIntensity(double var1) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.HeatMapItem@$refId::setIntensity([\'var1\':$var1])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::setIntensity',
  ...
  Future<Int32List> getIndexes() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.HeatMapItem@$refId::getIndexes([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::getIndexes',
            {"__this__": this});
  ...
  Future<void> setIndexes(Int32List var1) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.HeatMapItem@$refId::setIndexes([\'var1\':$var1])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::setIndexes',
            {"var1": var1, "__this__": this});
...
extension com_amap_api_maps_model_HeatMapItem_Batch
    on List<com_amap_api_maps_model_HeatMapItem> {
  //region getters
  ...
  Future<List<com_amap_api_maps_model_LatLng>> getCenter_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::getCenter_batch', [
  ...
  Future<List<void>> setCenter_batch(
      List<double> var1, List<double> var3) async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::setCenter_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"var1": var1[__i__], "var3": var3[__i__], "__this__": this[__i__]}
    ]);
  ...
  Future<List<double>> getIntensity_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.HeatMapItem::getIntensity_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<void>> setIntensity_batch(List<double> var1) async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.HeatMapItem::setIntensity_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
  ...
  Future<List<Int32List>> getIndexes_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::getIndexes_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<void>> setIndexes_batch(List<Int32List> var1) async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.HeatMapItem::setIndexes_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"var1": var1[__i__], "__this__": this[__i__]}
    ]);
