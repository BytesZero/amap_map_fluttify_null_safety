...
class com_amap_api_maps_model_CameraPositionCreator extends java_lang_Object {
  ...
  //region creators
  static Future<com_amap_api_maps_model_CameraPositionCreator>
      create__() async {
    ...
    final object = com_amap_api_maps_model_CameraPositionCreator()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_model_CameraPositionCreator>>
    ...
    final List<com_amap_api_maps_model_CameraPositionCreator> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_CameraPositionCreator()..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_CameraPositionCreator_Batch
    on List<com_amap_api_maps_model_CameraPositionCreator> {
  //region getters
