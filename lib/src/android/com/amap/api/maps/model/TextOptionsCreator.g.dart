...
class com_amap_api_maps_model_TextOptionsCreator extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_TextOptionsCreator>>
    ...
    final List<com_amap_api_maps_model_TextOptionsCreator> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_TextOptionsCreator()..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_TextOptionsCreator_Batch
    on List<com_amap_api_maps_model_TextOptionsCreator> {
  //region getters
