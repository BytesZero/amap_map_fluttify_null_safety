...
class com_amap_api_maps_model_IndoorBuildingInfo extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_IndoorBuildingInfo>>
    ...
    final List<com_amap_api_maps_model_IndoorBuildingInfo> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_IndoorBuildingInfo()..refId = result)
            .toList();
    return typedResult;
  }
  ...
  Future<String> get_activeFloorName() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.IndoorBuildingInfo::get_activeFloorName",
            {'__this__': this});
  ...
  Future<int> get_activeFloorIndex() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.IndoorBuildingInfo::get_activeFloorIndex",
            {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<String> get_poiid() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("com.amap.api.maps.model.IndoorBuildingInfo::get_poiid",
            {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<Int32List> get_floor_indexs() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.IndoorBuildingInfo::get_floor_indexs",
            {'__this__': this});
  ...
  Future<List<String>> get_floor_names() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.IndoorBuildingInfo::get_floor_names",
            {'__this__': this});
  ...
  Future<void> set_activeFloorName(String activeFloorName) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.IndoorBuildingInfo::set_activeFloorName',
            <String, dynamic>{
          '__this__': this,
  ...
  Future<void> set_activeFloorIndex(int activeFloorIndex) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.IndoorBuildingInfo::set_activeFloorIndex',
            <String, dynamic>{
          '__this__': this,
  ...
  Future<void> set_poiid(String poiid) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.IndoorBuildingInfo::set_poiid',
            <String, dynamic>{'__this__': this, "poiid": poiid});
  }
  ...
  Future<void> set_floor_indexs(Int32List floor_indexs) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.IndoorBuildingInfo::set_floor_indexs',
            <String, dynamic>{'__this__': this, "floor_indexs": floor_indexs});
  }
  ...
  Future<void> set_floor_names(List<String> floor_names) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.IndoorBuildingInfo::set_floor_names',
            <String, dynamic>{'__this__': this, "floor_names": floor_names});
  }
...
extension com_amap_api_maps_model_IndoorBuildingInfo_Batch
    on List<com_amap_api_maps_model_IndoorBuildingInfo> {
  //region getters
  Future<List<String>> get_activeFloorName_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.IndoorBuildingInfo::get_activeFloorName_batch",
            [
  ...
  Future<List<int>> get_activeFloorIndex_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.IndoorBuildingInfo::get_activeFloorIndex_batch",
            [
          for (final __item__ in this) {'__this__': __item__}
        ]);
  ...
  Future<List<String>> get_poiid_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.IndoorBuildingInfo::get_poiid_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<Int32List>> get_floor_indexs_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.IndoorBuildingInfo::get_floor_indexs_batch",
            [
          for (final __item__ in this) {'__this__': __item__}
        ]);
  ...
  Future<List<List<String>>> get_floor_names_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "com.amap.api.maps.model.IndoorBuildingInfo::get_floor_names_batch",
            [
          for (final __item__ in this) {'__this__': __item__}
        ]);
    ...
    final typedResult = (resultBatch as List)
        .cast<List<String>>()
        .map((__result__) => (__result__ as List).cast<String>())
        .toList();
    return typedResult;
  }
  ...
  Future<void> set_activeFloorName_batch(List<String> activeFloorName) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            'com.amap.api.maps.model.IndoorBuildingInfo::set_activeFloorName_batch',
            [
          for (int __i__ = 0; __i__ < length; __i__++)
            {'__this__': this[__i__], "activeFloorName": activeFloorName[__i__]}
        ]);
  }
  ...
  Future<void> set_activeFloorIndex_batch(List<int> activeFloorIndex) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod(
            'com.amap.api.maps.model.IndoorBuildingInfo::set_activeFloorIndex_batch',
            [
          for (int __i__ = 0; __i__ < length; __i__++)
            {
              '__this__': this[__i__],
              "activeFloorIndex": activeFloorIndex[__i__]
            }
        ]);
  }
  ...
  Future<void> set_poiid_batch(List<String> poiid) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod(
            'com.amap.api.maps.model.IndoorBuildingInfo::set_poiid_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "poiid": poiid[__i__]}
    ]);
  }
  ...
  Future<void> set_floor_indexs_batch(List<Int32List> floor_indexs) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod(
            'com.amap.api.maps.model.IndoorBuildingInfo::set_floor_indexs_batch',
            [
          for (int __i__ = 0; __i__ < length; __i__++)
            {'__this__': this[__i__], "floor_indexs": floor_indexs[__i__]}
        ]);
  }
  ...
  Future<void> set_floor_names_batch(List<List<String>> floor_names) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod(
            'com.amap.api.maps.model.IndoorBuildingInfo::set_floor_names_batch',
            [
          for (int __i__ = 0; __i__ < length; __i__++)
            {'__this__': this[__i__], "floor_names": floor_names[__i__]}
        ]);
  }
