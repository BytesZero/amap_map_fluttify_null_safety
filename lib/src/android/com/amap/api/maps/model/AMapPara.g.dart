...
class com_amap_api_maps_model_AMapPara extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_AMapPara>> create_batch__(
      int length) async {
    if (false) {
    ...
    final List<com_amap_api_maps_model_AMapPara> typedResult = resultBatch
        .map((result) => com_amap_api_maps_model_AMapPara()..refId = result)
        .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_AMapPara_Batch
    on List<com_amap_api_maps_model_AMapPara> {
  //region getters
