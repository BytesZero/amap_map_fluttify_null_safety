...
class com_amap_api_maps_model_LatLngBounds_Builder extends java_lang_Object {
  ...
  static Future<com_amap_api_maps_model_LatLngBounds_Builder> create__() async {
    ...
    final object = com_amap_api_maps_model_LatLngBounds_Builder()
      ..refId = refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_maps_model_LatLngBounds_Builder>>
    ...
    final List<com_amap_api_maps_model_LatLngBounds_Builder> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_LatLngBounds_Builder()..refId = result)
            .toList();
    return typedResult;
  }
  ...
  Future<com_amap_api_maps_model_LatLngBounds_Builder> include(
      com_amap_api_maps_model_LatLng var1) async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.LatLngBounds.Builder@$refId::include([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.LatLngBounds.Builder::include',
  ...
  Future<com_amap_api_maps_model_LatLngBounds> build() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.LatLngBounds.Builder@$refId::build([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.LatLngBounds.Builder::build',
            {"__this__": this});
...
extension com_amap_api_maps_model_LatLngBounds_Builder_Batch
    on List<com_amap_api_maps_model_LatLngBounds_Builder> {
  //region getters
  ...
  Future<List<com_amap_api_maps_model_LatLngBounds_Builder>> include_batch(
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.LatLngBounds.Builder::include_batch', [
  ...
  Future<List<com_amap_api_maps_model_LatLngBounds>> build_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.LatLngBounds.Builder::build_batch', [
