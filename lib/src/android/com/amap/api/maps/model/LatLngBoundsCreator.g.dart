...
class com_amap_api_maps_model_LatLngBoundsCreator extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_LatLngBoundsCreator>>
    ...
    final List<com_amap_api_maps_model_LatLngBoundsCreator> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_LatLngBoundsCreator()..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_LatLngBoundsCreator_Batch
    on List<com_amap_api_maps_model_LatLngBoundsCreator> {
  //region getters
