...
class com_amap_api_maps_model_NaviPara extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_model_NaviPara>> create_batch__(
      int length) async {
    if (false) {
    ...
    final List<com_amap_api_maps_model_NaviPara> typedResult = resultBatch
        .map((result) => com_amap_api_maps_model_NaviPara()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<void> setTargetPoint(com_amap_api_maps_model_LatLng var1) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.NaviPara@$refId::setTargetPoint([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.NaviPara::setTargetPoint',
  ...
  Future<void> setNaviStyle(int var1) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.NaviPara@$refId::setNaviStyle([\'var1\':$var1])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.NaviPara::setNaviStyle',
            {"var1": var1, "__this__": this});
  ...
  Future<com_amap_api_maps_model_LatLng> getTargetPoint() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.NaviPara@$refId::getTargetPoint([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.NaviPara::getTargetPoint',
            {"__this__": this});
  ...
  Future<int> getNaviStyle() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.NaviPara@$refId::getNaviStyle([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.NaviPara::getNaviStyle',
            {"__this__": this});
...
extension com_amap_api_maps_model_NaviPara_Batch
    on List<com_amap_api_maps_model_NaviPara> {
  //region getters
  ...
  Future<List<void>> setTargetPoint_batch(
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.NaviPara::setTargetPoint_batch', [
  ...
  Future<List<void>> setNaviStyle_batch(List<int> var1) async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.NaviPara::setNaviStyle_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"var1": var1[__i__], "__this__": this[__i__]}
    ]);
  ...
  Future<List<com_amap_api_maps_model_LatLng>> getTargetPoint_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.NaviPara::getTargetPoint_batch', [
  ...
  Future<List<int>> getNaviStyle_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.NaviPara::getNaviStyle_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
