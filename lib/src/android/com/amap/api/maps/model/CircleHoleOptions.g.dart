...
class com_amap_api_maps_model_CircleHoleOptions
    extends com_amap_api_maps_model_BaseHoleOptions with android_os_Parcelable {
  //region constants
  ...
  static Future<List<com_amap_api_maps_model_CircleHoleOptions>> create_batch__(
      int length) async {
    if (false) {
    ...
    final List<com_amap_api_maps_model_CircleHoleOptions> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_CircleHoleOptions()..refId = result)
            .toList();
    return typedResult;
  }
  ...
  Future<com_amap_api_maps_model_CircleHoleOptions> center(
      com_amap_api_maps_model_LatLng var1) async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.CircleHoleOptions@$refId::center([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.CircleHoleOptions::center',
    ...
    if (__result__ == null) {
      ...
      final __return__ = com_amap_api_maps_model_CircleHoleOptions()
        ..refId = __result__;
      return __return__;
    }
  }
  ...
  Future<com_amap_api_maps_model_CircleHoleOptions> radius(double var1) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.CircleHoleOptions@$refId::radius([\'var1\':$var1])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.CircleHoleOptions::radius',
            {"var1": var1, "__this__": this});
  ...
  Future<com_amap_api_maps_model_LatLng> getCenter() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.CircleHoleOptions@$refId::getCenter([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.CircleHoleOptions::getCenter',
            {"__this__": this});
  ...
  Future<double> getRadius() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.CircleHoleOptions@$refId::getRadius([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.model.CircleHoleOptions::getRadius',
            {"__this__": this});
...
extension com_amap_api_maps_model_CircleHoleOptions_Batch
    on List<com_amap_api_maps_model_CircleHoleOptions> {
  //region getters
  ...
  Future<List<com_amap_api_maps_model_CircleHoleOptions>> center_batch(
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.CircleHoleOptions::center_batch', [
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List)
          .cast<String>()
          .map((__result__) =>
              com_amap_api_maps_model_CircleHoleOptions()..refId = __result__)
          .toList();
      return typedResult;
    }
  }

  Future<List<com_amap_api_maps_model_CircleHoleOptions>> radius_batch(
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.CircleHoleOptions::radius_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"var1": var1[__i__], "__this__": this[__i__]}
    ]);
  ...
  Future<List<com_amap_api_maps_model_LatLng>> getCenter_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.CircleHoleOptions::getCenter_batch', [
  ...
  Future<List<double>> getRadius_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.CircleHoleOptions::getRadius_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
