...
class com_amap_api_maps_model_particle_ParticleOverlayOptionsFactory
  ...
  //region creators
  static Future<com_amap_api_maps_model_particle_ParticleOverlayOptionsFactory>
      create__() async {
  ...
  static Future<
          List<com_amap_api_maps_model_particle_ParticleOverlayOptionsFactory>>
    ...
    final List<com_amap_api_maps_model_particle_ParticleOverlayOptionsFactory>
  ...
  static Future<List<com_amap_api_maps_model_particle_ParticleOverlayOptions>>
      defaultOptions(int var0) async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.model.particle.ParticleOverlayOptionsFactory::defaultOptions([\'var0\':$var0])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.particle.ParticleOverlayOptionsFactory::defaultOptions',
            {"var0": var0});
...
extension com_amap_api_maps_model_particle_ParticleOverlayOptionsFactory_Batch
    on List<com_amap_api_maps_model_particle_ParticleOverlayOptionsFactory> {
  //region getters
  ...
  static Future<
          List<List<com_amap_api_maps_model_particle_ParticleOverlayOptions>>>
      defaultOptions_batch(List<int> var0) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.model.particle.ParticleOverlayOptionsFactory::defaultOptions_batch',
            [
