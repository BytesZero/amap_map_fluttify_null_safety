...
class com_amap_api_maps_model_VisibleRegionCreator extends java_lang_Object {
  ...
  static Future<com_amap_api_maps_model_VisibleRegionCreator> create__() async {
    ...
    final object = com_amap_api_maps_model_VisibleRegionCreator()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_model_VisibleRegionCreator>>
    ...
    final List<com_amap_api_maps_model_VisibleRegionCreator> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_model_VisibleRegionCreator()..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_model_VisibleRegionCreator_Batch
    on List<com_amap_api_maps_model_VisibleRegionCreator> {
  //region getters
