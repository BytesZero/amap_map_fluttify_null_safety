...
class com_amap_api_maps_SwipeDismissTouchListener extends java_lang_Object
  ...
  //region creators
  static Future<com_amap_api_maps_SwipeDismissTouchListener>
      create__android_view_View__java_lang_Object__com_amap_api_maps_SwipeDismissTouchListener_DismissCallbacks(
          android_view_View var1,
          Object var2,
  ...
  static Future<List<com_amap_api_maps_SwipeDismissTouchListener>>
      create_batch__android_view_View__java_lang_Object__com_amap_api_maps_SwipeDismissTouchListener_DismissCallbacks(
          List<android_view_View> var1,
          List<Object> var2,
          List<com_amap_api_maps_SwipeDismissTouchListener_DismissCallbacks>
              var3) async {
    ...
    final List<com_amap_api_maps_SwipeDismissTouchListener> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_SwipeDismissTouchListener()..refId = result)
            .toList();
    return typedResult;
  }
  ...
  Future<bool> onTouch(
      android_view_View var1, android_view_MotionEvent var2) async {
    // print log
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.SwipeDismissTouchListener@$refId::onTouch([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.SwipeDismissTouchListener::onTouch',
...
extension com_amap_api_maps_SwipeDismissTouchListener_Batch
    on List<com_amap_api_maps_SwipeDismissTouchListener> {
  //region getters
  ...
  Future<List<bool>> onTouch_batch(
      List<android_view_View> var1, List<android_view_MotionEvent> var2) async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.SwipeDismissTouchListener::onTouch_batch', [
