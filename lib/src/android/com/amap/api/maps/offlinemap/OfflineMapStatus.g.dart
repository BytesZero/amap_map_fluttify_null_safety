...
class com_amap_api_maps_offlinemap_OfflineMapStatus extends java_lang_Object {
  ...
  //region creators
  static Future<com_amap_api_maps_offlinemap_OfflineMapStatus>
      create__() async {
    ...
    final object = com_amap_api_maps_offlinemap_OfflineMapStatus()
      ..refId = refId;
    return object;
  }

  static Future<List<com_amap_api_maps_offlinemap_OfflineMapStatus>>
    ...
    final List<com_amap_api_maps_offlinemap_OfflineMapStatus> typedResult =
        resultBatch
            .map((result) =>
                com_amap_api_maps_offlinemap_OfflineMapStatus()..refId = result)
            .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_offlinemap_OfflineMapStatus_Batch
    on List<com_amap_api_maps_offlinemap_OfflineMapStatus> {
  //region getters
