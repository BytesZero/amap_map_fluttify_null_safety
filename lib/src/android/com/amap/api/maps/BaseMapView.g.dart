...
mixin com_amap_api_maps_BaseMapView on java_lang_Object {
  static com_amap_api_maps_BaseMapView subInstance() =>
      _com_amap_api_maps_BaseMapView_SUB();
  ...
  Future<void> loadWorldVectorMap(bool var1) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.BaseMapView@$refId::loadWorldVectorMap([\'var1\':$var1])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('com.amap.api.maps.BaseMapView::loadWorldVectorMap',
...
extension com_amap_api_maps_BaseMapView_Batch
    on List<com_amap_api_maps_BaseMapView> {
  //region methods
  ...
  Future<List<void>> loadWorldVectorMap_batch(List<bool> var1) async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.BaseMapView::loadWorldVectorMap_batch', [
