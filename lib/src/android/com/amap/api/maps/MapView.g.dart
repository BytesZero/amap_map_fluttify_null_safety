...
class com_amap_api_maps_MapView extends android_widget_FrameLayout
  ...
  //region creators
  static Future<com_amap_api_maps_MapView> create__android_content_Context(
  ...
  static Future<com_amap_api_maps_MapView>
  ...
  static Future<List<com_amap_api_maps_MapView>>
    ...
    final List<com_amap_api_maps_MapView> typedResult = resultBatch
        .map((result) => com_amap_api_maps_MapView()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<com_amap_api_maps_AMap> getMap({bool viewChannel = true}) async {
    ...
    final __result__ = await MethodChannel(
            viewChannel
                ? 'me.yohom/amap_map_fluttify/com_amap_api_maps_MapView'
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::getMap', {"__this__": this});
  ...
  Future<void> onCreate(android_os_Bundle var1,
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.MapView@$refId::onCreate([])');
    }
    ...
    final __result__ = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::onCreate',
  ...
  Future<void> onResume({bool viewChannel = true}) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.MapView@$refId::onResume([])');
    }
    ...
    final __result__ = await MethodChannel(
            ...
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.MapView::onResume', {"__this__": this});
  ...
  Future<void> onPause({bool viewChannel = true}) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.MapView@$refId::onPause([])');
    }
    ...
    final __result__ = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::onPause', {"__this__": this});
  ...
  Future<void> onDestroy({bool viewChannel = true}) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.MapView@$refId::onDestroy([])');
    }
    ...
    final __result__ = await MethodChannel(
            ...
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.MapView::onDestroy', {"__this__": this});
  ...
  Future<void> onLowMemory({bool viewChannel = true}) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.MapView@$refId::onLowMemory([])');
    }
    ...
    final __result__ = await MethodChannel(
            ...
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'com.amap.api.maps.MapView::onLowMemory', {"__this__": this});
  ...
  Future<void> onSaveInstanceState(android_os_Bundle var1,
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.MapView@$refId::onSaveInstanceState([])');
    }
    ...
    final __result__ = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::onSaveInstanceState',
            {"var1": var1, "__this__": this});
  ...
  Future<void> setVisibility(int var1, {bool viewChannel = true}) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: com.amap.api.maps.MapView@$refId::setVisibility([\'var1\':$var1])');
    }
    ...
    final __result__ = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::setVisibility',
            {"var1": var1, "__this__": this});
  ...
  Future<List<com_amap_api_maps_AMap>> getMap_batch(
    ...
    final resultBatch = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::getMap_batch', [
  ...
  Future<List<void>> onCreate_batch(List<android_os_Bundle> var1,
    ...
    final resultBatch = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::onCreate_batch', [
  ...
  Future<List<void>> onResume_batch({bool viewChannel = true}) async {
    ...
    final resultBatch = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::onResume_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<void>> onPause_batch({bool viewChannel = true}) async {
    ...
    final resultBatch = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::onPause_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<void>> onDestroy_batch({bool viewChannel = true}) async {
    ...
    final resultBatch = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::onDestroy_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<void>> onLowMemory_batch({bool viewChannel = true}) async {
    ...
    final resultBatch = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::onLowMemory_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<void>> onSaveInstanceState_batch(List<android_os_Bundle> var1,
    ...
    final resultBatch = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::onSaveInstanceState_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"var1": var1[__i__], "__this__": this[__i__]}
    ]);
  ...
  Future<List<void>> setVisibility_batch(List<int> var1,
    ...
    final resultBatch = await MethodChannel(
            viewChannel
                ...
                : 'me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('com.amap.api.maps.MapView::setVisibility_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"var1": var1[__i__], "__this__": this[__i__]}
    ]);
