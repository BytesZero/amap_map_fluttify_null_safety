...
class com_amap_api_maps_AMapOptionsCreator extends java_lang_Object {
  ...
  static Future<List<com_amap_api_maps_AMapOptionsCreator>> create_batch__(
      int length) async {
    if (false) {
    ...
    final List<com_amap_api_maps_AMapOptionsCreator> typedResult = resultBatch
        .map((result) => com_amap_api_maps_AMapOptionsCreator()..refId = result)
        .toList();
    return typedResult;
  }
...
extension com_amap_api_maps_AMapOptionsCreator_Batch
    on List<com_amap_api_maps_AMapOptionsCreator> {
  //region getters
