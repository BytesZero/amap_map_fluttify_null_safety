...
class MATouchPoi extends NSObject {
  ...
  static Future<MATouchPoi> create__({bool init = true /* ios only */}) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMATouchPoi', {'init': init});
    final object = MATouchPoi()..refId = refId;
    return object;
  }

  static Future<List<MATouchPoi>> create_batch__(int length,
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMATouchPoi',
            {'length': length, 'init': init});

    final List<MATouchPoi> typedResult =
        resultBatch.map((result) => MATouchPoi()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<String> get_name() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATouchPoi::get_name", {'__this__': this});
  ...
  Future<CLLocationCoordinate2D> get_coordinate() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATouchPoi::get_coordinate", {'__this__': this});
  ...
  Future<String> get_uid() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATouchPoi::get_uid", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
...
extension MATouchPoi_Batch on List<MATouchPoi> {
  ...
  Future<List<String>> get_name_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATouchPoi::get_name_batch", [
  ...
  Future<List<CLLocationCoordinate2D>> get_coordinate_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATouchPoi::get_coordinate_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<String>> get_uid_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATouchPoi::get_uid_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
