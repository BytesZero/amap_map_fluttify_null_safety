...
class MAHeatMapNode extends NSObject {
  ...
  //region creators
  static Future<MAHeatMapNode> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAHeatMapNode', {'init': init});
    final object = MAHeatMapNode()..refId = refId;
    return object;
  }

  static Future<List<MAHeatMapNode>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAHeatMapNode',
            {'length': length, 'init': init});

    final List<MAHeatMapNode> typedResult =
        resultBatch.map((result) => MAHeatMapNode()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<CLLocationCoordinate2D> get_coordinate() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAHeatMapNode::get_coordinate", {'__this__': this});
  ...
  Future<double> get_intensity() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAHeatMapNode::get_intensity", {'__this__': this});
  ...
  Future<void> set_coordinate(CLLocationCoordinate2D coordinate) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAHeatMapNode::set_coordinate',
  ...
  Future<void> set_intensity(double intensity) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAHeatMapNode::set_intensity',
...
extension MAHeatMapNode_Batch on List<MAHeatMapNode> {
  ...
  Future<List<CLLocationCoordinate2D>> get_coordinate_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAHeatMapNode::get_coordinate_batch", [
  ...
  Future<List<double>> get_intensity_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAHeatMapNode::get_intensity_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<void> set_coordinate_batch(
    ...
    await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MAHeatMapNode::set_coordinate_batch', [
  ...
  Future<void> set_intensity_batch(List<double> intensity) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('MAHeatMapNode::set_intensity_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
