...
class MATileOverlayRenderer extends MAOverlayRenderer {
  ...
  //region creators
  static Future<MATileOverlayRenderer> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            'ObjectFactory::createMATileOverlayRenderer', {'init': init});
    final object = MATileOverlayRenderer()..refId = refId;
    return object;
  }

  static Future<List<MATileOverlayRenderer>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMATileOverlayRenderer',
            {'length': length, 'init': init});

    final List<MATileOverlayRenderer> typedResult = resultBatch
        .map((result) => MATileOverlayRenderer()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<MATileOverlay> get_tileOverlay() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "MATileOverlayRenderer::get_tileOverlay", {'__this__': this});
  ...
  Future<MATileOverlayRenderer> initWithTileOverlay(
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MATileOverlayRenderer::initWithTileOverlay',
            {"tileOverlay": tileOverlay, "__this__": this});
  ...
  Future<void> reloadData() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MATileOverlayRenderer::reloadData', {"__this__": this});
...
extension MATileOverlayRenderer_Batch on List<MATileOverlayRenderer> {
  ...
  Future<List<MATileOverlay>> get_tileOverlay_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATileOverlayRenderer::get_tileOverlay_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);

    final typedResult = (resultBatch as List)
        .cast<String>()
        .map((__result__) => MATileOverlay()..refId = __result__)
        .toList();
    return typedResult;
  }
  ...
  Future<List<MATileOverlayRenderer>> initWithTileOverlay_batch(
      List<MATileOverlay> tileOverlay) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MATileOverlayRenderer::initWithTileOverlay_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"tileOverlay": tileOverlay[__i__], "__this__": this[__i__]}
    ]);
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List)
          .cast<String>()
          .map((__result__) => MATileOverlayRenderer()..refId = __result__)
          .toList();
      return typedResult;
    }
  }
  ...
  Future<List<void>> reloadData_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MATileOverlayRenderer::reloadData_batch', [
