...
class _MAParticleRotationGenerate_SUB extends NSObject
    with MAParticleRotationGenerate {}

mixin MAParticleRotationGenerate on NSObject {
  static MAParticleRotationGenerate subInstance() =>
      _MAParticleRotationGenerate_SUB();
  ...
  Future<double> getRotate() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAParticleRotationGenerate@$refId::getRotate([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            'MAParticleRotationGenerate::getRotate', {"__this__": this});
...
extension MAParticleRotationGenerate_Batch on List<MAParticleRotationGenerate> {
  ...
  Future<List<double>> getRotate_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAParticleRotationGenerate::getRotate_batch', [
