...
class MAHeatMapVectorItem extends NSObject {
  ...
  //region creators
  static Future<MAHeatMapVectorItem> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            'ObjectFactory::createMAHeatMapVectorItem', {'init': init});
    final object = MAHeatMapVectorItem()..refId = refId;
    return object;
  }

  static Future<List<MAHeatMapVectorItem>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAHeatMapVectorItem',
            {'length': length, 'init': init});

    final List<MAHeatMapVectorItem> typedResult = resultBatch
        .map((result) => MAHeatMapVectorItem()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<MAMapPoint> get_center() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAHeatMapVectorItem::get_center", {'__this__': this});
  ...
  Future<double> get_intensity() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAHeatMapVectorItem::get_intensity", {'__this__': this});
  ...
  Future<List<num>> get_nodeIndices() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "MAHeatMapVectorItem::get_nodeIndices", {'__this__': this});
...
extension MAHeatMapVectorItem_Batch on List<MAHeatMapVectorItem> {
  ...
  Future<List<MAMapPoint>> get_center_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAHeatMapVectorItem::get_center_batch", [
  ...
  Future<List<double>> get_intensity_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAHeatMapVectorItem::get_intensity_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<List<num>>> get_nodeIndices_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAHeatMapVectorItem::get_nodeIndices_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
