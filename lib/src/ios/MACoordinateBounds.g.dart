...
class MACoordinateBounds extends NSObject {
  ...
  //region creators
  static Future<MACoordinateBounds> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            'ObjectFactory::createMACoordinateBounds', {'init': init});
    final object = MACoordinateBounds()..refId = refId;
    return object;
  }

  static Future<List<MACoordinateBounds>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMACoordinateBounds',
            {'length': length, 'init': init});

    final List<MACoordinateBounds> typedResult = resultBatch
        .map((result) => MACoordinateBounds()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<CLLocationCoordinate2D> get_northEast() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateBounds::get_northEast", {'__this__': this});
  ...
  Future<CLLocationCoordinate2D> get_southWest() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateBounds::get_southWest", {'__this__': this});
    return __result__ == null
        ? null
        : (CLLocationCoordinate2D()..refId = __result__);
  }
  ...
  Future<void> set_northEast(CLLocationCoordinate2D northEast) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MACoordinateBounds::set_northEast',
            <String, dynamic>{'__this__': this, "northEast": northEast});
  }

  Future<void> set_southWest(CLLocationCoordinate2D southWest) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MACoordinateBounds::set_southWest',
            <String, dynamic>{'__this__': this, "southWest": southWest});
  }
...
extension MACoordinateBounds_Batch on List<MACoordinateBounds> {
  ...
  Future<List<CLLocationCoordinate2D>> get_northEast_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateBounds::get_northEast_batch", [
  ...
  Future<List<CLLocationCoordinate2D>> get_southWest_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateBounds::get_southWest_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<void> set_northEast_batch(
      List<CLLocationCoordinate2D> northEast) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('MACoordinateBounds::set_northEast_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "northEast": northEast[__i__]}
    ]);
  }

  Future<void> set_southWest_batch(
      List<CLLocationCoordinate2D> southWest) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('MACoordinateBounds::set_southWest_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "southWest": southWest[__i__]}
    ]);
  }
