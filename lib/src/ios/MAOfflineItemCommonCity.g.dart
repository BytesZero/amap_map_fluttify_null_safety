...
class MAOfflineItemCommonCity extends MAOfflineCity {
  ...
  //region creators
  static Future<MAOfflineItemCommonCity> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            'ObjectFactory::createMAOfflineItemCommonCity', {'init': init});
    final object = MAOfflineItemCommonCity()..refId = refId;
    return object;
  }

  static Future<List<MAOfflineItemCommonCity>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAOfflineItemCommonCity',
            {'length': length, 'init': init});

    final List<MAOfflineItemCommonCity> typedResult = resultBatch
        .map((result) => MAOfflineItemCommonCity()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<MAOfflineItem> get_province() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "MAOfflineItemCommonCity::get_province", {'__this__': this});
  ...
  Future<void> set_province(MAOfflineItem province) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAOfflineItemCommonCity::set_province',
            <String, dynamic>{'__this__': this, "province": province});
  }
...
extension MAOfflineItemCommonCity_Batch on List<MAOfflineItemCommonCity> {
  ...
  Future<List<MAOfflineItem>> get_province_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineItemCommonCity::get_province_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);

    final typedResult = (resultBatch as List)
        .cast<String>()
        .map((__result__) => MAOfflineItem()..refId = __result__)
        .toList();
    return typedResult;
  }
  ...
  Future<void> set_province_batch(List<MAOfflineItem> province) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MAOfflineItemCommonCity::set_province_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "province": province[__i__]}
    ]);
  }
