...
class MAIndoorInfo extends NSObject {
  ...
  //region creators
  static Future<MAIndoorInfo> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAIndoorInfo', {'init': init});
    final object = MAIndoorInfo()..refId = refId;
    return object;
  }

  static Future<List<MAIndoorInfo>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAIndoorInfo',
            {'length': length, 'init': init});

    final List<MAIndoorInfo> typedResult =
        resultBatch.map((result) => MAIndoorInfo()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<String> get_cnName() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_cnName", {'__this__': this});
  ...
  Future<String> get_enName() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_enName", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<String> get_poiID() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_poiID", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<String> get_buildingType() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_buildingType", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<int> get_activeFloorIndex() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_activeFloorIndex", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<int> get_activeFloorInfoIndex() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "MAIndoorInfo::get_activeFloorInfoIndex", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<List<dynamic>> get_floorInfo() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_floorInfo", {'__this__': this});
  ...
  Future<int> get_numberOfFloor() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_numberOfFloor", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<int> get_numberOfParkFloor() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "MAIndoorInfo::get_numberOfParkFloor", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
...
extension MAIndoorInfo_Batch on List<MAIndoorInfo> {
  ...
  Future<List<String>> get_cnName_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_cnName_batch", [
  ...
  Future<List<String>> get_enName_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_enName_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<String>> get_poiID_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_poiID_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<String>> get_buildingType_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_buildingType_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<int>> get_activeFloorIndex_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_activeFloorIndex_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<int>> get_activeFloorInfoIndex_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_activeFloorInfoIndex_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<List<dynamic>>> get_floorInfo_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_floorInfo_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<int>> get_numberOfFloor_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_numberOfFloor_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<int>> get_numberOfParkFloor_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorInfo::get_numberOfParkFloor_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
