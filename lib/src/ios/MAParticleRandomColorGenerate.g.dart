...
class MAParticleRandomColorGenerate extends NSObject
  ...
  //region creators
  static Future<MAParticleRandomColorGenerate> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAParticleRandomColorGenerate',
            {'init': init});
    final object = MAParticleRandomColorGenerate()..refId = refId;
    return object;
  }

  static Future<List<MAParticleRandomColorGenerate>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List<MAParticleRandomColorGenerate> typedResult = resultBatch
        .map((result) => MAParticleRandomColorGenerate()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<MAParticleRandomColorGenerate>
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAParticleRandomColorGenerate::initWithBoundaryColorR1_G1_B1_A1_R2_G2_B2_A2',
            {
          "r1": r1,
          "g1": g1,
          "b1": b1,
...
extension MAParticleRandomColorGenerate_Batch
    on List<MAParticleRandomColorGenerate> {
  //region getters
  ...
  Future<List<MAParticleRandomColorGenerate>>
      initWithBoundaryColorR1_G1_B1_A1_R2_G2_B2_A2_batch(
          List<double> r1,
          List<double> g1,
          List<double> b1,
          List<double> a1,
          ...
          List<double> g2,
          List<double> b2,
          List<double> a2) async {
    if (r1.length != g1.length ||
        g1.length != b1.length ||
        b1.length != a1.length ||
        a1.length != r2.length ||
        r2.length != g2.length ||
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAParticleRandomColorGenerate::initWithBoundaryColorR1_G1_B1_A1_R2_G2_B2_A2_batch',
            [
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List)
          .cast<String>()
          .map((__result__) =>
              MAParticleRandomColorGenerate()..refId = __result__)
          .toList();
      return typedResult;
    }
  }
