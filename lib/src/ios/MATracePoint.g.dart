...
class MATracePoint extends NSObject with NSCoding {
  ...
  //region creators
  static Future<MATracePoint> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMATracePoint', {'init': init});
    final object = MATracePoint()..refId = refId;
    return object;
  }

  static Future<List<MATracePoint>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMATracePoint',
            {'length': length, 'init': init});

    final List<MATracePoint> typedResult =
        resultBatch.map((result) => MATracePoint()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<double> get_latitude() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATracePoint::get_latitude", {'__this__': this});
  ...
  Future<double> get_longitude() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATracePoint::get_longitude", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<void> set_latitude(double latitude) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MATracePoint::set_latitude',
            <String, dynamic>{'__this__': this, "latitude": latitude});
  }

  Future<void> set_longitude(double longitude) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MATracePoint::set_longitude',
            <String, dynamic>{'__this__': this, "longitude": longitude});
  }
...
extension MATracePoint_Batch on List<MATracePoint> {
  ...
  Future<List<double>> get_latitude_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATracePoint::get_latitude_batch", [
  ...
  Future<List<double>> get_longitude_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MATracePoint::get_longitude_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<void> set_latitude_batch(List<double> latitude) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MATracePoint::set_latitude_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "latitude": latitude[__i__]}
    ]);
  }
  ...
  Future<void> set_longitude_batch(List<double> longitude) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('MATracePoint::set_longitude_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "longitude": longitude[__i__]}
    ]);
  }
