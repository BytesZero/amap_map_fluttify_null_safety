...
class MACircleRenderer extends MAOverlayPathRenderer {
  ...
  //region creators
  static Future<MACircleRenderer> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMACircleRenderer', {'init': init});
    final object = MACircleRenderer()..refId = refId;
    return object;
  }

  static Future<List<MACircleRenderer>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMACircleRenderer',
            {'length': length, 'init': init});

    final List<MACircleRenderer> typedResult = resultBatch
        .map((result) => MACircleRenderer()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<MACircle> get_circle() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACircleRenderer::get_circle", {'__this__': this});
  ...
  Future<MACircleRenderer> initWithCircle(MACircle circle) async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MACircleRenderer::initWithCircle',
...
extension MACircleRenderer_Batch on List<MACircleRenderer> {
  ...
  Future<List<MACircle>> get_circle_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACircleRenderer::get_circle_batch", [
  ...
  Future<List<MACircleRenderer>> initWithCircle_batch(
      List<MACircle> circle) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MACircleRenderer::initWithCircle_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"circle": circle[__i__], "__this__": this[__i__]}
    ]);
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List)
          .cast<String>()
          .map((__result__) => MACircleRenderer()..refId = __result__)
          .toList();
      return typedResult;
    }
  }
