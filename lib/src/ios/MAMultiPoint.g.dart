...
class MAMultiPoint extends MAShape with MAAnnotation {
  ...
  //region creators
  static Future<MAMultiPoint> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAMultiPoint', {'init': init});
    final object = MAMultiPoint()..refId = refId;
    return object;
  }

  static Future<List<MAMultiPoint>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAMultiPoint',
            {'length': length, 'init': init});

    final List<MAMultiPoint> typedResult =
        resultBatch.map((result) => MAMultiPoint()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<List<MAMapPoint>> get_points() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMultiPoint::get_points", {'__this__': this});
    return __result__ == null
        ? null
        : ((__result__ as List)
            .cast<String>()
            .map((__it__) => MAMapPoint()..refId = __it__)
            .toList());
  }
  ...
  Future<int> get_pointCount() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMultiPoint::get_pointCount", {'__this__': this});
  ...
  Future<bool> get_cross180Longitude() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "MAMultiPoint::get_cross180Longitude", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
...
extension MAMultiPoint_Batch on List<MAMultiPoint> {
  ...
  Future<List<List<MAMapPoint>>> get_points_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMultiPoint::get_points_batch", [
  ...
  Future<List<int>> get_pointCount_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMultiPoint::get_pointCount_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<bool>> get_cross180Longitude_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMultiPoint::get_cross180Longitude_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
