...
class MAOfflineCity extends MAOfflineItem {
  ...
  //region creators
  static Future<MAOfflineCity> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAOfflineCity', {'init': init});
    final object = MAOfflineCity()..refId = refId;
    return object;
  }

  static Future<List<MAOfflineCity>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAOfflineCity',
            {'length': length, 'init': init});

    final List<MAOfflineCity> typedResult =
        resultBatch.map((result) => MAOfflineCity()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<String> get_cityCode() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineCity::get_cityCode", {'__this__': this});
  ...
  Future<String> get_cityName() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineCity::get_cityName", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<String> get_urlString() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineCity::get_urlString", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
...
extension MAOfflineCity_Batch on List<MAOfflineCity> {
  ...
  Future<List<String>> get_cityCode_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineCity::get_cityCode_batch", [
  ...
  Future<List<String>> get_cityName_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineCity::get_cityName_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<String>> get_urlString_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineCity::get_urlString_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
