...
mixin MAParticleShapeModule on NSObject {
  ...
  Future<NSValue /* float* */ > getPoint() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MAParticleShapeModule::getPoint', {"__this__": this});
  ...
  Future<bool> isRatioEnable() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAParticleShapeModule@$refId::isRatioEnable([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAParticleShapeModule::isRatioEnable', {"__this__": this});
...
extension MAParticleShapeModule_Batch on List<MAParticleShapeModule> {
  ...
  Future<List<NSValue /* float* */ >> getPoint_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAParticleShapeModule::getPoint_batch', [
  ...
  Future<List<bool>> isRatioEnable_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAParticleShapeModule::isRatioEnable_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
