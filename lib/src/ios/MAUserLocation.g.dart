...
class MAUserLocation extends MAAnimatedAnnotation
  ...
  //region creators
  static Future<MAUserLocation> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAUserLocation', {'init': init});
    final object = MAUserLocation()..refId = refId;
    return object;
  }

  static Future<List<MAUserLocation>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAUserLocation',
            {'length': length, 'init': init});

    final List<MAUserLocation> typedResult =
        resultBatch.map((result) => MAUserLocation()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<bool> get_updating() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAUserLocation::get_isUpdating", {'__this__': this});
  ...
  Future<CLLocation> get_location() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAUserLocation::get_location", {'__this__': this});
  ...
  Future<CLHeading> get_heading() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAUserLocation::get_heading", {'__this__': this});
...
extension MAUserLocation_Batch on List<MAUserLocation> {
  ...
  Future<List<bool>> get_updating_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAUserLocation::get_isUpdating_batch", [
  ...
  Future<List<CLLocation>> get_location_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAUserLocation::get_location_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);

    final typedResult = (resultBatch as List)
        .cast<String>()
        .map((__result__) => CLLocation()..refId = __result__)
        .toList();
    return typedResult;
  }
  ...
  Future<List<CLHeading>> get_heading_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAUserLocation::get_heading_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);

    final typedResult = (resultBatch as List)
        .cast<String>()
        .map((__result__) => CLHeading()..refId = __result__)
        .toList();
    return typedResult;
  }
