...
class MAPathShowRange extends NSObject {
  ...
  //region creators
  static Future<MAPathShowRange> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAPathShowRange', {'init': init});
    final object = MAPathShowRange()..refId = refId;
    return object;
  }

  static Future<List<MAPathShowRange>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAPathShowRange',
            {'length': length, 'init': init});

    final List<MAPathShowRange> typedResult =
        resultBatch.map((result) => MAPathShowRange()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<double> get_begin() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAPathShowRange::get_begin", {'__this__': this});
  ...
  Future<double> get_end() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAPathShowRange::get_end", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<void> set_begin(double begin) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAPathShowRange::set_begin',
            <String, dynamic>{'__this__': this, "begin": begin});
  }

  Future<void> set_end(double end) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAPathShowRange::set_end',
            <String, dynamic>{'__this__': this, "end": end});
  }
...
extension MAPathShowRange_Batch on List<MAPathShowRange> {
  ...
  Future<List<double>> get_begin_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAPathShowRange::get_begin_batch", [
  ...
  Future<List<double>> get_end_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAPathShowRange::get_end_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<void> set_begin_batch(List<double> begin) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MAPathShowRange::set_begin_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "begin": begin[__i__]}
    ]);
  }
  ...
  Future<void> set_end_batch(List<double> end) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('MAPathShowRange::set_end_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "end": end[__i__]}
    ]);
  }
