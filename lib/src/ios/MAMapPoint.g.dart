...
class MAMapPoint extends NSObject {
  ...
  static Future<MAMapPoint> create__({bool init = true /* ios only */}) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAMapPoint', {'init': init});
    final object = MAMapPoint()..refId = refId;
    return object;
  }

  static Future<List<MAMapPoint>> create_batch__(int length,
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAMapPoint',
            {'length': length, 'init': init});

    final List<MAMapPoint> typedResult =
        resultBatch.map((result) => MAMapPoint()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<double> get_x() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMapPoint::get_x", {'__this__': this});
  ...
  Future<double> get_y() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMapPoint::get_y", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<void> set_x(double x) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAMapPoint::set_x', <String, dynamic>{'__this__': this, "x": x});
  }
  ...
  Future<void> set_y(double y) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAMapPoint::set_y', <String, dynamic>{'__this__': this, "y": y});
  }
...
extension MAMapPoint_Batch on List<MAMapPoint> {
  ...
  Future<List<double>> get_x_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMapPoint::get_x_batch", [
  ...
  Future<List<double>> get_y_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMapPoint::get_y_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<void> set_x_batch(List<double> x) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MAMapPoint::set_x_batch', [
  ...
  Future<void> set_y_batch(List<double> y) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('MAMapPoint::set_y_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
