...
class _MAParticleVelocityGenerate_SUB extends NSObject
    with MAParticleVelocityGenerate {}

mixin MAParticleVelocityGenerate on NSObject {
  static MAParticleVelocityGenerate subInstance() =>
      _MAParticleVelocityGenerate_SUB();
  ...
  Future<double> getX() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MAParticleVelocityGenerate::getX', {"__this__": this});
  ...
  Future<double> getY() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAParticleVelocityGenerate::getY', {"__this__": this});
  ...
  Future<double> getZ() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAParticleVelocityGenerate::getZ', {"__this__": this});
...
extension MAParticleVelocityGenerate_Batch on List<MAParticleVelocityGenerate> {
  ...
  Future<List<double>> getX_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAParticleVelocityGenerate::getX_batch', [
  ...
  Future<List<double>> getY_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAParticleVelocityGenerate::getY_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<double>> getZ_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAParticleVelocityGenerate::getZ_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
