...
class MAOfflineProvince extends MAOfflineItem {
  ...
  //region creators
  static Future<MAOfflineProvince> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAOfflineProvince', {'init': init});
    final object = MAOfflineProvince()..refId = refId;
    return object;
  }

  static Future<List<MAOfflineProvince>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAOfflineProvince',
            {'length': length, 'init': init});

    final List<MAOfflineProvince> typedResult = resultBatch
        .map((result) => MAOfflineProvince()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<List<dynamic>> get_cities() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineProvince::get_cities", {'__this__': this});
...
extension MAOfflineProvince_Batch on List<MAOfflineProvince> {
  ...
  Future<List<List<dynamic>>> get_cities_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineProvince::get_cities_batch", [
