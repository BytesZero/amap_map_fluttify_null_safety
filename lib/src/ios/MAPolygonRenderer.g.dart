...
class MAPolygonRenderer extends MAOverlayPathRenderer {
  ...
  //region creators
  static Future<MAPolygonRenderer> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAPolygonRenderer', {'init': init});
    final object = MAPolygonRenderer()..refId = refId;
    return object;
  }

  static Future<List<MAPolygonRenderer>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAPolygonRenderer',
            {'length': length, 'init': init});

    final List<MAPolygonRenderer> typedResult = resultBatch
        .map((result) => MAPolygonRenderer()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<MAPolygon> get_polygon() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAPolygonRenderer::get_polygon", {'__this__': this});
  ...
  Future<MAPolygonRenderer> initWithPolygon(MAPolygon polygon) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAPolygonRenderer@$refId::initWithPolygon([])');
    }

    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAPolygonRenderer::initWithPolygon',
...
extension MAPolygonRenderer_Batch on List<MAPolygonRenderer> {
  ...
  Future<List<MAPolygon>> get_polygon_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAPolygonRenderer::get_polygon_batch", [
  ...
  Future<List<MAPolygonRenderer>> initWithPolygon_batch(
      List<MAPolygon> polygon) async {
    if (false) {
      return Future.error('all args must have same length!');
    }
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAPolygonRenderer::initWithPolygon_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"polygon": polygon[__i__], "__this__": this[__i__]}
    ]);
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List)
          .cast<String>()
          .map((__result__) => MAPolygonRenderer()..refId = __result__)
          .toList();
      return typedResult;
    }
  }
