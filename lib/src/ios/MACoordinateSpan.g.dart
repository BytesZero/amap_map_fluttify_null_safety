...
class MACoordinateSpan extends NSObject {
  ...
  //region creators
  static Future<MACoordinateSpan> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMACoordinateSpan', {'init': init});
    final object = MACoordinateSpan()..refId = refId;
    return object;
  }

  static Future<List<MACoordinateSpan>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMACoordinateSpan',
            {'length': length, 'init': init});

    final List<MACoordinateSpan> typedResult = resultBatch
        .map((result) => MACoordinateSpan()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<double> get_latitudeDelta() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "MACoordinateSpan::get_latitudeDelta", {'__this__': this});
  ...
  Future<double> get_longitudeDelta() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "MACoordinateSpan::get_longitudeDelta", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<void> set_latitudeDelta(double latitudeDelta) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MACoordinateSpan::set_latitudeDelta', <String, dynamic>{
      '__this__': this,
  ...
  Future<void> set_longitudeDelta(double longitudeDelta) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MACoordinateSpan::set_longitudeDelta', <String, dynamic>{
      '__this__': this,
...
extension MACoordinateSpan_Batch on List<MACoordinateSpan> {
  ...
  Future<List<double>> get_latitudeDelta_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateSpan::get_latitudeDelta_batch", [
  ...
  Future<List<double>> get_longitudeDelta_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateSpan::get_longitudeDelta_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<void> set_latitudeDelta_batch(List<double> latitudeDelta) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MACoordinateSpan::set_latitudeDelta_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "latitudeDelta": latitudeDelta[__i__]}
    ]);
  }
  ...
  Future<void> set_longitudeDelta_batch(List<double> longitudeDelta) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('MACoordinateSpan::set_longitudeDelta_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "longitudeDelta": longitudeDelta[__i__]}
    ]);
  }
