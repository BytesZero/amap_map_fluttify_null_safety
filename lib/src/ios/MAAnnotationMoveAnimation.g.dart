...
class MAAnnotationMoveAnimation extends NSObject {
  ...
  //region creators
  static Future<MAAnnotationMoveAnimation> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            'ObjectFactory::createMAAnnotationMoveAnimation', {'init': init});
    final object = MAAnnotationMoveAnimation()..refId = refId;
    return object;
  }

  static Future<List<MAAnnotationMoveAnimation>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAAnnotationMoveAnimation',
            {'length': length, 'init': init});

    final List<MAAnnotationMoveAnimation> typedResult = resultBatch
        .map((result) => MAAnnotationMoveAnimation()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<String> name() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::name', {"__this__": this});
  ...
  Future<List<CLLocationCoordinate2D>> coordinates() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAAnnotationMoveAnimation@$refId::coordinates([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAAnnotationMoveAnimation::coordinates', {"__this__": this});
    ...
    if (__result__ == null) {
      ...
      final __return__ = (__result__ as List)
          .cast<String>()
          .map((__it__) => CLLocationCoordinate2D()..refId = __it__)
          .toList();
      return __return__;
    }
  }
  ...
  Future<int> count() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::count', {"__this__": this});
  ...
  Future<double> duration() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAAnnotationMoveAnimation@$refId::duration([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAAnnotationMoveAnimation::duration', {"__this__": this});
  ...
  Future<double> elapsedTime() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAAnnotationMoveAnimation@$refId::elapsedTime([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAAnnotationMoveAnimation::elapsedTime', {"__this__": this});
  ...
  Future<void> cancel() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::cancel', {"__this__": this});
  ...
  Future<bool> isCancelled() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAAnnotationMoveAnimation@$refId::isCancelled([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAAnnotationMoveAnimation::isCancelled', {"__this__": this});
  ...
  Future<int> passedPointCount() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAAnnotationMoveAnimation::passedPointCount', {"__this__": this});
...
extension MAAnnotationMoveAnimation_Batch on List<MAAnnotationMoveAnimation> {
  ...
  Future<List<String>> name_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::name_batch', [
  ...
  Future<List<List<CLLocationCoordinate2D>>> coordinates_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::coordinates_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<int>> count_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::count_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<double>> duration_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::duration_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<double>> elapsedTime_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::elapsedTime_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<void>> cancel_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::cancel_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<bool>> isCancelled_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::isCancelled_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<int>> passedPointCount_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnnotationMoveAnimation::passedPointCount_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
