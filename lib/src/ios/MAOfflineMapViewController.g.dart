...
class MAOfflineMapViewController extends UIViewController {
  ...
  //region creators
  static Future<MAOfflineMapViewController> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            'ObjectFactory::createMAOfflineMapViewController', {'init': init});
    final object = MAOfflineMapViewController()..refId = refId;
    return object;
  }

  static Future<List<MAOfflineMapViewController>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAOfflineMapViewController',
            {'length': length, 'init': init});

    final List<MAOfflineMapViewController> typedResult = resultBatch
        .map((result) => MAOfflineMapViewController()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<MAOfflineMap> get_offlineMap() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            "MAOfflineMapViewController::get_offlineMap", {'__this__': this});
  ...
  static Future<MAOfflineMapViewController> sharedInstance() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAOfflineMapViewController::sharedInstance([])');
    }
...
extension MAOfflineMapViewController_Batch on List<MAOfflineMapViewController> {
  ...
  Future<List<MAOfflineMap>> get_offlineMap_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAOfflineMapViewController::get_offlineMap_batch", [
  ...
  static Future<List<MAOfflineMapViewController>> sharedInstance_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
      'MAOfflineMapViewController::sharedInstance_batch',
    );
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List)
          .cast<String>()
          .map((__result__) => MAOfflineMapViewController()..refId = __result__)
          .toList();
      return typedResult;
    }
  }
