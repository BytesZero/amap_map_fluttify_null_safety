...
class MAMapSize extends NSObject {
  ...
  static Future<MAMapSize> create__({bool init = true /* ios only */}) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAMapSize', {'init': init});
    final object = MAMapSize()..refId = refId;
    return object;
  }

  static Future<List<MAMapSize>> create_batch__(int length,
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAMapSize',
            {'length': length, 'init': init});

    final List<MAMapSize> typedResult =
        resultBatch.map((result) => MAMapSize()..refId = result).toList();
    return typedResult;
  }
  ...
  Future<double> get_width() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMapSize::get_width", {'__this__': this});
  ...
  Future<double> get_height() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMapSize::get_height", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<void> set_width(double width) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAMapSize::set_width',
            <String, dynamic>{'__this__': this, "width": width});
  }

  Future<void> set_height(double height) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAMapSize::set_height',
...
extension MAMapSize_Batch on List<MAMapSize> {
  ...
  Future<List<double>> get_width_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMapSize::get_width_batch", [
  ...
  Future<List<double>> get_height_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAMapSize::get_height_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<void> set_width_batch(List<double> width) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MAMapSize::set_width_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "width": width[__i__]}
    ]);
  }
  ...
  Future<void> set_height_batch(List<double> height) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('MAMapSize::set_height_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
