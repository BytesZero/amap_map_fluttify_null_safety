...
class MAIndoorFloorInfo extends NSObject {
  ...
  //region creators
  static Future<MAIndoorFloorInfo> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('ObjectFactory::createMAIndoorFloorInfo', {'init': init});
    final object = MAIndoorFloorInfo()..refId = refId;
    return object;
  }

  static Future<List<MAIndoorFloorInfo>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMAIndoorFloorInfo',
            {'length': length, 'init': init});

    final List<MAIndoorFloorInfo> typedResult = resultBatch
        .map((result) => MAIndoorFloorInfo()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<String> get_floorName() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorFloorInfo::get_floorName", {'__this__': this});
  ...
  Future<int> get_floorIndex() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorFloorInfo::get_floorIndex", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<String> get_floorNona() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorFloorInfo::get_floorNona", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
  ...
  Future<bool> get_isPark() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorFloorInfo::get_isPark", {'__this__': this});
    return __result__ == null ? null : (__result__);
  }
...
extension MAIndoorFloorInfo_Batch on List<MAIndoorFloorInfo> {
  ...
  Future<List<String>> get_floorName_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorFloorInfo::get_floorName_batch", [
  ...
  Future<List<int>> get_floorIndex_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorFloorInfo::get_floorIndex_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<String>> get_floorNona_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorFloorInfo::get_floorNona_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
  ...
  Future<List<bool>> get_isPark_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MAIndoorFloorInfo::get_isPark_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);
