...
class MACoordinateRegion extends NSObject {
  ...
  //region creators
  static Future<MACoordinateRegion> create__(
    ...
    final refId = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod(
            'ObjectFactory::createMACoordinateRegion', {'init': init});
    final object = MACoordinateRegion()..refId = refId;
    return object;
  }

  static Future<List<MACoordinateRegion>> create_batch__(int length,
      {bool init = true /* ios only */}) async {
    if (false) {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('ObjectFactory::create_batchMACoordinateRegion',
            {'length': length, 'init': init});

    final List<MACoordinateRegion> typedResult = resultBatch
        .map((result) => MACoordinateRegion()..refId = result)
        .toList();
    return typedResult;
  }
  ...
  Future<CLLocationCoordinate2D> get_center() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateRegion::get_center", {'__this__': this});
  ...
  Future<MACoordinateSpan> get_span() async {
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateRegion::get_span", {'__this__': this});
  ...
  Future<void> set_center(CLLocationCoordinate2D center) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MACoordinateRegion::set_center',
            <String, dynamic>{'__this__': this, "center": center});
  }

  Future<void> set_span(MACoordinateSpan span) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MACoordinateRegion::set_span',
            <String, dynamic>{'__this__': this, "span": span});
  }
...
extension MACoordinateRegion_Batch on List<MACoordinateRegion> {
  ...
  Future<List<CLLocationCoordinate2D>> get_center_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateRegion::get_center_batch", [
  ...
  Future<List<MACoordinateSpan>> get_span_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod("MACoordinateRegion::get_span_batch", [
      for (final __item__ in this) {'__this__': __item__}
    ]);

    final typedResult = (resultBatch as List)
        .cast<String>()
        .map((__result__) => MACoordinateSpan()..refId = __result__)
        .toList();
    return typedResult;
  }
  ...
  Future<void> set_center_batch(List<CLLocationCoordinate2D> center) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MACoordinateRegion::set_center_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "center": center[__i__]}
    ]);
  }
  ...
  Future<void> set_span_batch(List<MACoordinateSpan> span) async {
    await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec()))
        .invokeMethod('MACoordinateRegion::set_span_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {'__this__': this[__i__], "span": span[__i__]}
    ]);
  }
