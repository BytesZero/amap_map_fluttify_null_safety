...
class _MAParticleColorGenerate_SUB extends NSObject
    with MAParticleColorGenerate {}

mixin MAParticleColorGenerate on NSObject {
  static MAParticleColorGenerate subInstance() =>
      _MAParticleColorGenerate_SUB();
  ...
  Future<NSValue /* float* */ > getColor() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MAParticleColorGenerate::getColor', {"__this__": this});
...
extension MAParticleColorGenerate_Batch on List<MAParticleColorGenerate> {
  ...
  Future<List<NSValue /* float* */ >> getColor_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAParticleColorGenerate::getColor_batch', [
