...
mixin MAAnimatableAnnotation on NSObject {
  ...
  Future<void> step(double timeDelta) async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAAnimatableAnnotation@$refId::step([\'timeDelta\':$timeDelta])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
        ...
        .invokeMethod('MAAnimatableAnnotation::step',
            {"timeDelta": timeDelta, "__this__": this});
  ...
  Future<bool> isAnimationFinished() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAAnimatableAnnotation@$refId::isAnimationFinished([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAAnimatableAnnotation::isAnimationFinished', {"__this__": this});
  ...
  Future<bool> shouldAnimationStart() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAAnimatableAnnotation@$refId::shouldAnimationStart([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAAnimatableAnnotation::shouldAnimationStart', {"__this__": this});
  ...
  Future<double> rotateDegree() async {
    ...
    if (fluttifyLogEnabled) {
      debugPrint(
          'fluttify-dart: MAAnimatableAnnotation@$refId::rotateDegree([])');
    }
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod(
            'MAAnimatableAnnotation::rotateDegree', {"__this__": this});
...
extension MAAnimatableAnnotation_Batch on List<MAAnimatableAnnotation> {
  ...
  Future<List<void>> step_batch(List<double> timeDelta) async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnimatableAnnotation::step_batch', [
      for (int __i__ = 0; __i__ < length; __i__++)
        {"timeDelta": timeDelta[__i__], "__this__": this[__i__]}
    ]);
  ...
  Future<List<bool>> isAnimationFinished_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnimatableAnnotation::isAnimationFinished_batch', [
  ...
  Future<List<bool>> shouldAnimationStart_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnimatableAnnotation::shouldAnimationStart_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
  ...
  Future<List<double>> rotateDegree_batch() async {
    ...
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify',
            StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify')))
        .invokeMethod('MAAnimatableAnnotation::rotateDegree_batch', [
      for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}
    ]);
